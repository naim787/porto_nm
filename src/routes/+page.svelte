...
<div class="w-[100vw] h-auto flex flex-col justify-center items-center bg-[radial-gradient(#BDBDBD_1px,transparent_0)] [background-size:30px_30px] overflow-x-hidden mcpe-font">
    ...
    <!-- about -->
    <div class="w-full h-[100vh] flex flex-col items-center gap-4">
      <!-- about -->
        ...
        <!-- skill -->
         <div class="w-[90vw] h-20 border-2 border-dashed border-gray-400 rounded-xl bg-white flex justify-evenly items-center">
          <!-- mobile v port -->
           ...
           <!-- api routs -->
           <img src="https://pbs.twimg.com/profile_images/1562960963359293446/rGjvMLR1_400x400.jpg" alt="nodjs" class="w-12"><img src="https://pbs.twimg.com/profile_images/1562960963359293446/rGjvMLR1_400x400.jpg" alt="nodjs" class="w-12">
           https://gin-gonic.com/_astro/gin.D6H2T_2v_ZD2G7l.webp
