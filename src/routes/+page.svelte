...
<div class="w-[100vw] h-auto flex flex-col justify-center items-center bg-[radial-gradient(#BDBDBD_1px,transparent_0)] [background-size:30px_30px] overflow-x-hidden mcpe-font">
    ...
    <div class="w-full h-[100vh] flex flex-row flex-wrap justify-evenly items-center gap-4">
      <!-- about -->
        <div class="w-115 h-100 bg-white rounded-xl border-4 border-dashed border-gray-400 relative p-2">
        ...
        <!-- skill -->
         <div class="w-115 h-auto border-4 border-dashed border-gray-400 rounded-xl flex justify-start items-center flex-wrap p-3 relative">
          <h1 class="text-8xl absolute left-[40%] top-[-20%] transform origin-center rotate-180 mcpe-font">^</h1>
          <div class="w-full">
