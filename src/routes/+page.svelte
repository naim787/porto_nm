...
<Navbar class="fixed bg-white border border-b-1 border-gray-200 z-10">
    ...
    <div class="w-full h-[100vh] flex flex-col items-center">
        <div class="w-80 h-100 bg-white rounded-xl border-4 border-dashed border-gray-400 relative p-2">
          ...
          <div class="h-[90%] overflow-y-scroll font-sans">
            <p class="">Lorem ipsum dolor sit amet consectetur adipisicinnullag elit. Quae deleniti asperiores consequuntur explicabo accusantium velit perspiciatis. Ut pariatur omnis similique repellat sit iste, corrupti minus! Ipsam asperiores quis, in neque ea obcaecati maxime nulla officiis optio atque eius quibusdam quisquam velit facilis impedit cupiditate provident! Voluptas eaque iure quod deserunt velit fugiat illo ea reiciendis doloremque culpa ex ullam amet, et reprehenderit quis blanditiis veritatis deleniti laboriosam fugit vitae. Inventore iste, temporibus id omnis facilis rem blanditiis modi fugiat ut corporis. Suscipit incidunt dolorum earum neque qui libero, eveniet eum ducimus a optio adipisci cupiditate, dolor asperiores est rem nihil!</p>
          </div>
        </div>
    </div>
