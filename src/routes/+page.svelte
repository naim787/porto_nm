        ...
        <!-- skill -->
         <div class="w-[90vw] h-20 border-2 border-dashed border-gray-400 rounded-xl bg-white flex justify-evenly items-center">
          <!-- mobile v port -->
           ...
           <img src="https://miro.medium.com/v2/resize:fit:470/format:webp/1*T1txuZBh1-Upx9c_po1bpA.png" alt="nodjs" class="w-20"><img src="https://miro.medium.com/v2/resize:fit:470/format:webp/1*T1txuZBh1-Upx9c_po1bpA.png" alt="nodjs" class="w-20">
