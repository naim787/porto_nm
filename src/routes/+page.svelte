        ...
        <!-- skill -->
         <div class="w-[90vw] h-20 border-2 border-dashed border-gray-400 rounded-xl bg-white flex justify-evenly items-center">
          <!-- mobile v port -->
           ...
           <img src="https://gin-gonic.com/_astro/gin.D6H2T_2v_ZD2G7l.webp" alt="nodjs" class="w-12"> <img src="https://gin-gonic.com/_astro/gin.D6H2T_2v_ZD2G7l.webp" alt="nodjs" class="w-12">
